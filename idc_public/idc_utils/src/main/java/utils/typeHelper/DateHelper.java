...
public class DateHelper {
	...
	static java.text.SimpleDateFormat sdfShort_time = new java.text.SimpleDateFormat("yyyy年MM月dd日HH-mm-ss");
	static java.text.SimpleDateFormat sdfShortLongTimePlusCn_ = new java.text.SimpleDateFormat("yyyy-MM-dd HH-mm-ss");
	...
	public static String getsdfShortLongTimePlusCn_(Date date)
	{
		String nowDate = "";
		try
		{
			if(date != null)
				nowDate = sdfShortLongTimePlusCn_.format(date);
			return nowDate;
		}
		catch (Exception e)
		{
	...
	public static String getNowFDate()
	{
		String nowDate = "";
		try
		{
			java.sql.Date date = null;
			date = new java.sql.Date(new java.util.Date().getTime());
			nowDate = sdfShort_time.format(date);
			return nowDate;
		}
		catch (Exception e)
		{
...
//	public static String convertDateToYearMonth(String date)
//	{
//		Date d = parse(date, aFormat);
//		
//		
//		SimpleDateFormat df = new SimpleDateFormat("yyyyMM", new DateFormatSymbols());
//		return df.format(d);
//	}
	...
	public static String getDayOfThisMonth(String day)
	{
		try
		{
			return getNowShortDate().substring(0, 6) + day;
		}
		catch (Exception e)
		{
			return "";
	...
	*/
	...
	public static java.sql.Timestamp getNextMonyDate(String strDate)
	{
		...
		try
		{
			int iYear = stringHelper.getStrToInt(getFormattedDate(strDate, "yyyy"));
			int iMonth = stringHelper.getStrToInt(getFormattedDate(strDate, "MM"));
			if (iMonth == 12)
			{
				iYear = iYear + 1;
			}
...
//	}
	...
	public static String getCurrDateTimeForFile(String suffixAliasName)
	{
		java.sql.Timestamp date = new java.sql.Timestamp(System.currentTimeMillis());
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy_MM_dd_hh_mm_ss");
		return formatter.format(date)+suffixAliasName;
	}
	...
	public static String getYYYYSplitMMFormattedDate(String strDate)
	{
		return getFormattedDate(strDate, "yyyy_MM");
	}
	...
	public static String getFormattedDateHelper(java.util.Date dtDate, String strFormatTo)
	{
		if (dtDate == null)
		{
			return "";
	...
	//-----------------------------------------------------------------------
	/**
	 * Gets the array of SimpleDateFormats that DateHelper knows about.
	**/
	...
	public static Date parseFromFormats(String aValue)
	{
		...
		// get DateHelper's formats
		SimpleDateFormat formats[] = DateHelper.getFormats();
		if (formats == null)
			return null;
		...
		for (int i = 0; i < formats.length; i++)
		{
			try
			{
				myDate = DateHelper.parse(aValue, formats[i]);
	...
	public static java.sql.Timestamp parseTimestampFromFormats(String aValue)
	{
		...
		Date myDate = DateHelper.parseFromFormats(aValue);
		if (myDate != null)
	...
	**/
	public static String formatDateString(String aString, SimpleDateFormat aFormat)
	{
		...
		if (stringHelper.isEmpty(aString) || aFormat == null)
			return "";
		try
		{
			...
			if (aDate != null)
			{
				return DateHelper.format(aDate, aFormat);
			}
		}
		catch (Exception e)
		{
	...
	**/
	public static Date parse(String aValue, SimpleDateFormat aFormat) throws ParseException
	{
		...
		if (stringHelper.isEmpty(aValue) || aFormat == null)
		{
			return null;
		}
	...
	**/
	...
	{
		return DateHelper.mFormat8chars;
	}
	...
	{
		return DateHelper.format(date, DateHelper.defaultTimestampFormat());
	}
	...
	{
		return DateHelper.format(date, DateHelper.defaultDateFormat());
	}
	...
	{
		return DateHelper.format(date, DateHelper.friendlyTimestampFormat());
	}
	...
	{
		return DateHelper.format(date, mFormat8chars);
	}
	...
	{
		return DateHelper.format(date, mFormatIso8601Day);
	}
	public static String formatIso8601Day(Timestamp timestamp)
	{
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(timestamp.getTime());
		return DateHelper.format(calendar.getTime(), mFormatIso8601Day);
	}
	public static String formatTradeEasy(Date date)
	{
		return DateHelper.format(date, mFormatTradeEasy);
	}
	//add by huyanzhi
	public static String formatTradeEasyProduct(Date date)
	{
		return DateHelper.format(date, mFormatTradeEasyProduct);
	}
	//

	public static String formatFormatTradeEasyMMddyyyy(Date date)
	{
		return DateHelper.format(date, mFormatTradeEasyMMddyyyy);
	}
	...
	public static String formatTradeEasy(Timestamp timestamp)
	{
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(timestamp.getTime());
		return DateHelper.format(calendar.getTime(), mFormatTradeEasy);
	}
	//-----------------------------------------------------------------------
	public static String formatRfc822(Date date)
	{
		return DateHelper.format(date, mFormatRfc822);
	}

	public static String formatExpire(Date date)
	{
		return DateHelper.format(date, mFormatExpire);
	}
	...
	public static String formatIso8601(Date date)
	{
		...
		String str = DateHelper.format(date, mFormatIso8601);
	...
	{
		return DateHelper.format(date, DateHelper.minimalDateFormat());
	}
	...
	{
		return DateHelper.friendlyDateFormat(false);
	}

	//-----------------------------------------------------------------------
	public static String fullDate(Date date)
	{
		return DateHelper.format(date, DateHelper.fullDateFormat());
	}
	...
	**/
	...
	{
		return DateHelper.format(date, DateHelper.friendlyDateFormat(minimalFormat));
	}
	...
	{
		return DateHelper.format(date, DateHelper.friendlyDateFormat(true));
	}
    ...
    **/
    ...
    public static String[] getDaysParams(int totalDaysOfCurrentMonth){
    	String[] dayParams = new String[31];
    	if(totalDaysOfCurrentMonth != 0){
    		for(int i = 0 ;i < totalDaysOfCurrentMonth; i++){
    			dayParams[i] = StringHelper.LPADStr(i+1);
    		}
    	}
    	return dayParams;
    }
    public static String[] getYYYMMDD(int totalDaysOfCurrentMonth){
    	String[] dayParams = new String[31];
    	if(totalDaysOfCurrentMonth != 0){
    		for(int i = 0 ;i < totalDaysOfCurrentMonth; i++){
    			dayParams[i] = getDayOfThisMonth(StringHelper.LPADStr(i+1));
    		}
    	}
    	return dayParams;
    }
    /**
     * 获取当月的记录
     * @param totalDaysOfCurrentMonth
     * @return
     * @throws Exception 
     */
    public static String[] getCurYYYYMMDDParams(int totalDaysOfCurrentMonth) throws Exception{
    	String[] dayParams = new String[31];
    	Date date = new Date();
    	int year = date.getYear();
    	int month = date.getMonth() ;
    	
    	String curOfYYYYMM = getNowShortDate();
    ...
    public static Date addDataWithMonth(Date startDate,Integer month){
		Calendar calendar=new GregorianCalendar();
		calendar.setTime(startDate);
		calendar.add(Calendar.MONTH, month);//把日期往后增加一个月.整数往后推,负数往前移动
		return calendar.getTime();   //这个时间就是日期往后推几个月的结果
	}
	public static Date addDataWithDay(Date startDate,Integer day){
		Calendar calendar=new GregorianCalendar();
		calendar.setTime(startDate);
		calendar.add(Calendar.DAY_OF_MONTH, day);//把日期往后增加天数.整数往后推,负数往前移动
		return calendar.getTime();
	}

	public static Date subDataWithMonth(Date startDate,Integer month){
		Calendar calendar=new GregorianCalendar();
		calendar.setTime(startDate);
		calendar.add(Calendar.MONTH, -month);//把日期往后增加一个月.整数往后推,负数往前移动
		return calendar.getTime();   //这个时间就是日期往后推几个月的结果
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String startDateStr = sdfLongTimePlus.format(startDate);
			System.out.println(getDateLong(startDate));
			System.out.println(getDateLong(startDate));
			System.out.println(getDateLong(startDate));
			System.out.println(getDateLong(startDate));
			System.out.println(getDateLong(startDate));
			System.out.println(startDateStr);
			Date date = addDataWithDay(startDate,1);
			//然后格式化
			String dateStr = sdfLongTimePlus.format(date);
	...
	public static Integer getTimeFormatIntger(Date date){
		...
		String strTemp = DateHelper.getFomartDate(date, "yyyyMMddHHmmss");
...
//		String nowTime = strTemp.substring(8,14);
	 ...
	 * @ author zhangyong
	 * @ 获取当月的第一天，2009-05-01*/
	public static String getStringOfFirstDayInMonth(String datestr) {
		Date date = new Date();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
		String temp = sdf.format(datestr);
