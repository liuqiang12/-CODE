...
public class SysOrganizationTreeClosure implements Serializable {
		
	public static final String tableName = "sys_organization_tree_closure";
...
/************************get set method**************************/
	...
	public Integer getIsparentnode() {
	    return this.isparentnode;
	}
 	
	@Column(name = "isParentNode" , nullable =  true)
	public void setIsparentnode(Integer isparentnode) {
	...
	@Column(name = "isrootnode" , nullable =  true)
	...
	public String toString() {
			return  "sysOrganizationTreeClosure [ancestor = "+this.ancestor+",descendant = "+this.descendant+",distance = "+this.distance+",createTime = "+this.createTime+",isparentnode = "+this.isparentnode+
