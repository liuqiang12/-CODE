...
public class SysRegionTreeClosure implements Serializable {

    public static final String tableName = "sys_region_tree_closure";
    ...
    public String toString() {
        return  "sysRegionTreeClosure [ancestor = "+this.ancestor+",descendant = "+this.descendant+",distance = "+this.distance+",createTime = "+this.createTime+" ]";
    }
