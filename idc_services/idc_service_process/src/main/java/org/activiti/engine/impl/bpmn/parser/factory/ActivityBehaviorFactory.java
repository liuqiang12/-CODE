...
public interface ActivityBehaviorFactory {
  ...
  ActivityBehavior createLogActivityBehavior(ServiceTask serviceTask, BpmnModel bpmnModel);
  ...
  BoundaryEventActivityBehavior createBoundaryEventActivityBehavior(BoundaryEvent boundaryEvent, boolean interrupting, ActivityImpl activity);
