...
public class IdcNotServerResource implements Serializable {
		
	public static final String tableName = "IDC_NOT_SERVER_RESOURCE";
...
/************************get set method**************************/
	...
	public String toString() {
			return  "idcNotServerResource [id = "+this.id+",resourceId = "+this.resourceId+",resourceCategory = "+this.resourceCategory+",ticketInstId = "+this.ticketInstId+",prodInstId = "+this.prodInstId+
