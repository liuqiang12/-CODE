...
public class IdcRunTicketResource extends TicketIdcRackVo implements Serializable {
		
	public static final String tableName = "IDC_RUN_TICKET_RESOURCE";
	...
	private String category;//类型:100机架 200端口带宽300ip租用400主机租赁500增值业务600代表机位（u位）
	...
	private String belongName;	/*资源所属名称*/
	...
	public String toString() {
			return  "idcHisTicketResource [id = "+this.id+",ticketInstId = "+this.ticketInstId+",resourceid = "+this.resourceid+",status = "+this.status+",manual = "+this.manual+
		",rev = "+this.rev+",createTime = "+this.createTime+",ipType = "+this.ipType+" ]";
	}
