...
public class IdcRunTicketOpen implements Serializable {
		
	public static final String tableName = "IDC_RUN_TICKET_OPEN";
...
/************************get set method**************************/
	...
	public String toString() {
			return  "idcRunTicketOpen [id = "+this.id+",ticketInstId = "+this.ticketInstId+",applydesc = "+this.applydesc+",occupycomment = "+this.occupycomment+",rev = "+this.rev+
