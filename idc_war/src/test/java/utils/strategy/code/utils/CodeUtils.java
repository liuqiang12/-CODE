...
public class CodeUtils {
	private static utils.strategy.code.utils.CodeUtils instance;
	private CodeUtils(){}
	 ...
	 * @return
	 */
	public static synchronized utils.strategy.code.utils.CodeUtils getInstance(){
		if(instance == null){
			instance = new utils.strategy.code.utils.CodeUtils();
		}
		return instance;
	}
	/**
	 ...
	 * @return
	 */
	public utils.strategy.code.utils.CodeUtils load(String sql, String propertyPath,String preChar){
		this.sql = sql;
	 ...
	 * @return
	 */
	public utils.strategy.code.utils.CodeUtils load(String sql, String propertyPath){
		this.sql = sql;
		this.propertyPath = propertyPath;
		return instance;
	}
...
//				}
	...
	public Map<String, List> queryColumnWithTable(Map<String, String> map,Boolean isReSql){
		...
		try {
			...
			while(rs.next()){
				...
				effectModel.setIsPri(columnKey != null && "PRI".equals(columnKey));
				...
				if(
					...
					effectModelWithDate.setIsPri(columnKey != null && "PRI".equals(columnKey));
					/**
					 * setget方法
					 */
	...
	public static void main(String[] args) throws Exception {
		...
		utils.strategy.code.utils.CodeUtils codeUtils = getInstance() ;
...
//		System.out.println(list); 
	...
	public TablePrimary getTablePrimary(List<ColumnBeanDataVO> entityAndDatabase){
		...
		while (it.hasNext()) {
			ColumnBeanDataVO columnBeanDataVO = it.next();
