        ...
        <div id="apply_info_layout" class="easyui-layout"  fit="true">
            ...
            <div data-options="region:'center'" style="padding:2px;">
                ...
                <tr>
                    ...
                    <td class="kv-content" colspan="3">
                        <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:720,height:80,multiline:true" name="comment" value="${categoryTicketMeta.APPLYDESC}"  data-options="validType:'length[0,255]'"/>
                    </td>
                </tr>--%>
                       <%-- <tr>
