            ...
            <fieldset class="fieldsetCls fieldsetHeadCls">
                ...
                <table class="kv-table">
                    ...
                    <tr>
                        ...
                        <td class="kv-content">
                            <input class="easyui-numberbox" readonly="readonly" name="contractprice" value="${idcContract.contractprice}" id="contractprice" data-options="required:true,precision:2,width:150,suffix:'元',min:0,validType:'length[0,12]'"/>
                        </td>
