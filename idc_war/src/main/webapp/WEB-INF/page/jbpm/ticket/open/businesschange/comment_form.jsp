                ...
                <form method="post" id="singleForm" action="<%=request.getContextPath() %>/actJBPMController/procCmentFormSaveOrUpdate.do">
                    <table class="kv-table">
                        ...
                        <%--<tr>
                            ...
                            <td class="kv-content" colspan="3">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:false,width:720,height:80,multiline:true"  value="${categoryTicketMeta.APPLYDESC}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>--%>
                        <tr>
                            <td class="kv-label"style="width:100px" >预勘占用</td>
                            <td class="kv-content" colspan="3">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:720,height:100,multiline:true"  value="${categoryTicketMeta.OCCUPYCOMMENT}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3">
                                ...
                                <input class="easyui-textbox" data-options="required:true,width:720,height:100,multiline:true" name="comment" value="${idcRunTicketCommnet.feedback}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                    </table>
                </form>
