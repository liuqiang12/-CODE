                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content" colspan="3">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:780,height:60,multiline:true" name="comment" value="${categoryTicketMeta.CONSTRUCT_COMMENT}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="kv-content"colspan="3">
                                ...
                                <input class="easyui-textbox" data-options="required:true,width:780,height:100,multiline:true" name="comment" value="${idcRunTicketCommnet.feedback}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                    </table>
                </form>
