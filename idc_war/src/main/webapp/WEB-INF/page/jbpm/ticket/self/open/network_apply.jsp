...
<div class="tip_float_right_info" style="height:23px;line-height:24px;width: 520px;">
                ...
                <fieldset class="fieldsetCls fieldsetHeadCls">
                    ...
                    <table class="kv-table">
                        <tr>
                            ...
                            <td class="kv-content">
                                <input type="hidden" name="ins_id" value="${idcNetServiceinfo.id}" id="idcNetServiceinfo.id"/>
