            ...
            <fieldset class="fieldsetCls fieldsetHeadCls">
                ...
                <table class="kv-table">
                    ...
                    <tr>
                        ...
                        <td class="kv-content">
                            <input name="idcReProductbusName" value="预勘申请" class="easyui-textbox" data-options="required:true,width:150">
                        </td>
                        <td class="kv-label">意向IDC<span style="color:red">&nbsp;*</span></td>
                        <td class="kv-content">
                            <input name="idcReProductidcName" value="中国（西部）云计算中心" class="easyui-textbox" data-options="required:true,width:150">
                        </td>
                        <td class="kv-label">预勘天数(天)<span style="color:red">&nbsp;*</span></td>
                        <td class="kv-content">
                            <input name="idcReProductvalidity" value="30" class="easyui-numberbox" data-options="required:true,width:150,min:0,validType:'length[0,4]'">
                        </td>
                    </tr>
                </table>
            </fieldset>
                ...
                <fieldset class="fieldsetCls fieldsetHeadCls" id="rack_fieldsetId">
                    ...
                    <table class="kv-table">
                        <tr>
                            ...
                            <td class="kv-content">
                                <input class="easyui-numberbox"  name="idcReRackModel.rackNum" value="${idcReRackModel.rackNum}"
                                       id="idcReRackModel_rackNum" data-options="precision:0,width:150,min:0,validType:'length[0,5]'"/>
                            </td>
                        </tr>
                        <tr>
