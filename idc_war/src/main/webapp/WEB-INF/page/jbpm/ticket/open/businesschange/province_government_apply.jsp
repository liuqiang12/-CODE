...
<div id="jbpmApply_tabs" class="easyui-tabs" fit="true">
                            ...
                            <div id="muiltFilesDiv">
                                ...
                                <%--<c:forEach items="${attachmentinfoList}" var="item" varStatus="index">
                                    <div class="attachHasedCls">
                                        ...
                                        &lt;%&ndash;<a href="javascript:void(0)" class="easyui-linkbutton" onclick="removeAttach(this,${item.id})" style="width:38px">删除</a>&ndash;%&gt;
    ...
    <div title="资源分配" data-options="closable:false" style="overflow:auto;padding:10px;display:none;">
        ...
        <!-- 【附件列表信息:可以操纵的都具有附件情况】 -->
        <jbpm:jbpmTag ticketItem="${}" module="TICKET_ATTACHMENT" gridId="ticketAttachmentGridId" title="工单附件列表"  maxHeight="150" toolbar="ticketAttachmentBbar"></jbpm:jbpmTag>
