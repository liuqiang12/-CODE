...
<div class="tip_float_right_info" style="height:23px;line-height:24px;width: 525px;">
    <marquee direction="left"onmouseover="this.stop();" onmouseout="this.start();" onstart="this.firstChild.innerHTML+=this.firstChild.innerHTML;" scrollamount="20" scrolldelay="400" behavior="SCROLL" hspace="0" vspace="0" loop="INFINITE">
