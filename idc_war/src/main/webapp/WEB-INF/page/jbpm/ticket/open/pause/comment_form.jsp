                ...
                <fieldset style="border-color: #c0e7fb;" class="fieldsetCls">
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content">
                                <input readonly="readonly" class="easyui-textbox" data-options="required:false,width:420,height:70,multiline:true" name="applydesc" value="${categoryTicketMeta.APPLYDESC}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                        <tr>
                                    <td class="kv-label"style="width:100px" >停机反馈</td>
                            <td class="kv-content">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:false,width:420,height:70,multiline:true" name="construct_comment" value="${categoryTicketMeta.CONSTRUCT_COMMENT}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
