                ...
                <table class="kv-table">
                    <tr>
                        ...
                        <td class="kv-content">
                            ...
                            <!-- 客户id -->
                            <input name="customer_Id" type="hidden" value="${idcReProduct.customerId}">
                            <!-- 客户名称 -->
                            <input name="customer_Name" type="hidden" value="${idcReProduct.customerName}">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="kv-label">合同期限<span style="color:red">&nbsp;*</span></td>
                        <td class="kv-content">
                    ...
                    <tr>
                        ...
                        <td class="kv-content" colspan="3">
                            <input class="easyui-textbox" multiline="true"  name="contractremark"  value="${idcContract.contractremark}" style="width:80%;height:50px" data-options="validType:'length[0,255]'">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="kv-content" colspan="3">
                            <div id="muiltFilesDiv">
                                <!-- 罗列出已经添加了的附件信息 -->
                                <jbpm:jbpmTag contractId="${idcContract.id}" module="IDC_CONTRACT_ATTACH" width="543"></jbpm:jbpmTag>
                                <div id="fileDiv0">
        ...
        <form method="post" id="singleForm" action="<%=request.getContextPath() %>/actJBPMController/procCmentFormSaveOrUpdate.do">
            ...
            <table class="kv-table">
                <tr>
                        ...
                        <input name="customer_Name" type="hidden" value="${idcReProduct.customerName}">
                        <!-- 是否是虚拟机 -->
                        <input name="idcNetServiceinfo_icpaccesstype" id="idcNetServiceinfo_icpaccesstype" type="hidden" value="${idcNetServiceinfo.icpaccesstype}">
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        /*   */
        var icpsrvname = '${idcNetServiceinfo.icpsrvname}';
        if(icpsrvname){
            //有服务的
            $("#fuwuNetServiceId").parents(".checkbackgrd").addClass("on_check");
            $("#qtNetServiceId").parents(".checkbackgrd").removeClass("on_check");
            $("input#idcRunProcCment_status_stand").val(1);
        }else{
            $("#fuwuNetServiceId").parents(".checkbackgrd").removeClass("on_check");
            $("#qtNetServiceId").parents(".checkbackgrd").addClass("on_check");
            $("input#idcRunProcCment_status_stand").val(0);
        }
    });
    /*下载附件信息*/
