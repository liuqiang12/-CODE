        ...
        <fieldset style="border-color: #c0e7fb;" class="fieldsetCls">
            ...
            <table class="kv-table" style="width: 100%;height: 100%">
                <tr>
                    ...
                    <td class="kv-content">
                        <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:150" name="name" value="${aaaa}"  id="name" data-options="validType:'length[0,64]'"/>
                    </td>
                    ...
                    <td class="kv-content">
                        <input class="easyui-combobox" readonly="readonly" data-options="
								...
								data: [{
									...
									label: '其他',
									value: '999'
								}]" value="999"  name="attribute" id="attribute"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="kv-content">
                        ...
                        <input class="easyui-combobox" readonly="readonly" data-options="
								...
								data: [{
									...
									label: '其他',
									value: '999'
								}]" value="9"  name="idcardtype" id="idcardtype"/>
                    </td>
                ...
                <tr>
                    ...
                    <td class="kv-content">
                        <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:150" name="zipcode" value="${zipcode}"  id="zipcode" data-options="validType:'length[0,6]'"/>
                    </td>

                    <td class="kv-label">注册时间</td>${aaaa}
                    <td class="kv-content">
                ...
                <fieldset class="fieldsetCls fieldsetHeadCls">
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content">
                                <input class="easyui-textbox" readonly="readonly" name="idcNetServiceinfo.icpdomain" value="${idcNetServiceinfo.icpdomain}"  id="idcNetServiceinfo.icpdomain" data-options="required:true,validType:'length[0,128]',width:200"/>
                            </td>
                    ...
                    <fieldset class="fieldsetCls fieldsetHeadCls">
                        ...
                        <table class="kv-table">
                            <tr>
                                <td class="kv-label" style="width: 200px;">名称</td>
                                <td class="kv-content">
                                    <input readonly="readonly"  class="easyui-textbox" name="idcNetServiceinfo.vmName" value="${idcNetServiceinfo.vmName}"  id="idcNetServiceinfo.vmName" data-options="required:true,validType:'length[0,128]',width:150"/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="kv-content">
                                    ...
                                    <input readonly="readonly"  class="easyui-textbox" name="idcNetServiceinfo.vmNetAddr" value="${idcNetServiceinfo.vmNetAddr}"  id="idcNetServiceinfo.vmNetAddr" data-options="required:true,validType:'length[0,128]',width:150"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="kv-label">管理地址</td>
                                <td class="kv-content">
                                    <input readonly="readonly"  class="easyui-textbox" name="idcNetServiceinfo.vmManagerAddr" value="${idcNetServiceinfo.vmManagerAddr}"  id="idcNetServiceinfo.vmManagerAddr" data-options="required:true,validType:'length[0,128]',width:150"/>
                                </td>
