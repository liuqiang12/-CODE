...
<div id="jbpmApply_tabs" class="easyui-tabs" fit="true">
                ...
                <table class="kv-table">
                    ...
                    <tr>
                        ...
                        <td class="kv-content" colspan="3">
                            <input class="easyui-textbox"  readonly="readonly" multiline="true"  name="contractremark"  value="${idcContract.contractremark}" style="width:82%;height:50px" data-options="validType:'length[0,255]'">
                        </td>
                    </tr>
                    <tr>
    ...
    <jbpm:jbpmTag title="相关工单" hasOtherTicket="2" gridId="his_ticket_gridId" module="OTHER_LINKED_TICKET" toolbar="requestParamSettins_hisShowTaskQuery" prodInstId="${prodInstId}" ticketInstId="${ticketInstId}"></jbpm:jbpmTag>
    <!-- 资源分配 end -->
