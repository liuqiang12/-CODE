...
<div id="jbpmApply_tabs" class="easyui-tabs" fit="true">
    ...
    <div title="流程图" data-options="closable:false" style="overflow:auto;padding:10px;display:none;">
        <!-- 加载流程图 -->
        <jbpm:jbpmTag module="ACTIVITI_DIAGRAM" processInstanceId="${processInstanceId}" processDefinitionId="${processDefinitionId}" processDefinitionKey="${processDefinitionKey}"></jbpm:jbpmTag>
    </div>
                ...
                <form method="post" id="singleForm" action="<%=request.getContextPath() %>/actJBPMController/procCmentFormSaveOrUpdate.do">
                    ...
                    <table class="kv-table">
                        <tr>
                            ...
                            <td class="kv-content">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:false,width:420,height:100,multiline:true" value="${categoryTicketMeta.HALTREASON}" />
                            </td>
                        </tr>
                        <tr>
                            <td class="kv-label"style="width:100px" >备注 </td>
                            <td class="kv-content">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:false,width:420,height:100,multiline:true" name="applydesc" value="${categoryTicketMeta.APPLYDESC}" />
                            </td>
                        </tr>
                        ...
                        <tr>
                                ...
                                <input class="easyui-textbox" data-options="required:true,width:420" readonly="readonly" value="${serialNumber}"  />
                        </tr>
                        <tr>
