            ...
            <div data-options="region:'center'" style="padding:2px;">
                <form method="post" id="singleForm" action="<%=request.getContextPath() %>/actJBPMController/procCmentFormSaveOrUpdate.do">
                    <table class="kv-table">
                        ...
                        <!-- 勘察反馈 -->
                        <%--<tr>
                            <td class="kv-label"style="width:100px" >勘察反馈</td>
                            <td class="kv-content" colspan="3">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:420,height:100,multiline:true"  value="${categoryTicketMeta.OCCUPYCOMMENT}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>--%>
                        <tr>
