                ...
                <table class="kv-table">
                    <tr>
                        ...
                        <td class="kv-content">
                            ...
                            <input readonly="readonly" name="isRejectTicket" type="hidden" value="${idcHisTicket.isRejectTicket}">
                            <!-- 合同的工单id -->
                    ...
                    <tr>
                        ...
                        <td class="kv-label">客户信息<span style="color:red">&nbsp;*</span></td>
                        <td class="kv-content">
                            <!--  -->
...
<script type="text/javascript">
    ...
    function userDNSAdd(newValue,oldValue){
        ...
        var fieldsetHTML = '<fieldset class="fieldsetCls fieldsetHeadCls">'+
            ...
            '  <input class="easyui-textbox" name="idcNetServiceinfo.icpsrvname" value="${idcNetServiceinfo.icpsrvname}"  id="icpsrvname" data-options="required:true,validType:\'length[0,64]\',width:250"/>'+
            '  </td>'+
            '  <td class="kv-label">所属用户</td>'+
            '   <td class="kv-content">'+
            '   <input name="idcNetServiceinfo.customerId" value="${idcReCustomer.id}" type="hidden" />'+
            ...
            ' <td class="kv-content">'+
            '   <input class="easyui-textbox" name="idcNetServiceinfo.icprecordno" value="${idcNetServiceinfo.icprecordno}"  id="icprecordno" data-options="required:true,validType:\'length[0,64]\',width:250"/>'+
            '   </td>'+
