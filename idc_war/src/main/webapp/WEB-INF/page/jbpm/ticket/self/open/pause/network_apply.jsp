                ...
                <fieldset style="border-color: #c0e7fb;" class="fieldsetCls">
                    ...
                    <table class="kv-table">
                        ...
                        <tr>
                            ...
                            <td class="kv-content">
                                <input readonly="readonly" class="easyui-textbox" data-options="required:false,width:420,height:100,multiline:true" name="applydesc" value="${categoryTicketMeta.APPLYDESC}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>
                        <%--<tr>
                            <td class="kv-label"style="width:100px" >反馈客户信息</td>
                            <td class="kv-content">
                                <input class="easyui-textbox" readonly="readonly" data-options="required:false,width:420,height:100,multiline:true" name="construct_comment" value="${idcRunProcCment.construct_comment}"  data-options="validType:'length[0,255]'"/>
                            </td>
                        </tr>--%>
                    </table>
                </fieldset>
