...
<div id="jbpmForm_tabs" class="easyui-tabs" fit="true">
                ...
                <table class="kv-table">
                    <tr>
                        ...
                        <td class="kv-content">
                            ...
                            <input readonly="readonly" class="easyui-textbox" name="contractname" value="${idcContract.contractname}"  id="contractname" data-options="required:false,validType:'length[0,128]',width:150"/>
                        </td>
                        <td class="kv-label">编码</td>
                        <td class="kv-content">
                            <input readonly="readonly" class="easyui-textbox" name="contractno" value="${idcContract.contractno}"  id="contractno" data-options="required:false,validType:'length[0,128]',width:150"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="kv-label">价格(元)</td>
                        <td class="kv-content">
                            <input readonly="readonly" class="easyui-numberbox" name="contractprice" value="${idcContract.contractprice}" id="contractprice" data-options="required:false,width:150,min:0,validType:'length[0,12]'"/>
                        </td>
                        ...
                        <td class="kv-content">
                            ...
                            <input readonly="readonly" id="idcContract_customerName" value="${idcReCustomer.name}" class="easyui-textbox" data-options="editable:false,required:false,width:150">
                        </td>
                    </tr>
                    <tr>
                        <td class="kv-label">开始时间</td>
                        <td class="kv-content">
                            <input readonly="readonly" class="easyui-datetimebox"  name="contractstart" value="${idcContract.contractstart}" data-options="required:false,editable:false,showSeconds:true,width:150">
                        </td>

                        <td class="kv-label">合同期限(月)</td>
                        <td class="kv-content">
                            <input readonly="readonly" class="easyui-numberbox" name="contractperiod" value="${idcContract.contractperiod}" id="contractperiod" data-options="required:false,precision:0,min:0,validType:'length[0,10]',width:150"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="kv-label">签订日期</td>
                        <td class="kv-content">
                            <input readonly="readonly" class="easyui-datetimebox"  name="contractsigndate" value="${idcContract.contractsigndate}" data-options="required:false,editable:false,showSeconds:true,width:150">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="kv-content" colspan="3">
                            <input readonly="readonly" class="easyui-textbox" multiline="true"  name="contractremark"  value="${idcContract.contractremark}" style="width:82%;height:50px" data-options="validType:'length[0,255]'">
                        </td>
                    </tr>
                    <tr>
    ...
    <!-- 提交开通意见 -->
    <div title="停机原因" data-options="closable:false" style="overflow:auto;padding:10px;display:none;">
        <!--
            工单号
            显示申请人
            申请理由
        ...
        <form method="post" id="singleForm" action="<%=request.getContextPath() %>/actJBPMController/procCmentFormSaveOrUpdate.do">
            ...
            <table class="kv-table">
                ...
                <input name="pauseTpye" id="idcRunProcCment_pauseStatus_stand" value="<c:if test="${empty idcRunProcCment.pauseTpye}">1</c:if><c:if test="${not empty idcRunProcCment.pauseTpye}">${idcRunProcCment.pauseTpye}</c:if>" type="hidden"/>
                <div style="position:relative;margin: 0px;" >
                    ...
                    <tr>
                        ...
                        <td class="kv-content">
                            ...
                            开始时间<input class="easyui-datetimebox"  name="reservestart" value="${idcRunProcCment.reservestart}" data-options="required:true,editable:false,showSeconds:true,width:150">
                            -结束时间<input class="easyui-datetimebox"  name="reserveend" value="${idcRunProcCment.reserveend}" data-options="required:true,editable:false,showSeconds:true,width:150">
                            <font color="#FF0000">注意：停机时间不能超过30天</font>
                        </td>
                    </tr>
                </div>
                </td>
...
<script type="text/javascript">
    ...
    function icpaccesstypeOnChange(newValue,oldValue){
        ...
        if(newValue != oldValue && newValue == '1'){
            ...
            var fieldsetHTML = '<fieldset class="fieldsetCls fieldsetHeadCls">'+
                ...
                '       label: \'不可用\','+
                '       value: \'-1\''+
                '   }]" value="${idcNetServiceinfo.vmStatus}"  name="idcNetServiceinfo.vmStatus" id="ins_vmStatus"/>'+
                '   </td>'+
                '   </tr>'+
                '   <tr>'+
    ...
    function form_sbmt(grid,jbpmFunFlag){
        ...
        $("#singleForm").form('submit', {
            url:contextPath+"/actJBPMController/procPauseFormSaveOrUpdate.do",
            onSubmit: function(){
                if(!$("#singleForm").form("validate")){
                    ...
                    $("#jbpmForm_tabs").tabs("select","停机原因");
                    return false;
                }
            },
            success:function(data){
