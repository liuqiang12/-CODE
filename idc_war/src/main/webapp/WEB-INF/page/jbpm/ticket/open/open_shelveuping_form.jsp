                ...
                <table class="kv-table">
                    ...
                    <tr>
                        ...
                        <td class="kv-content" colspan="3">
                            <input class="easyui-textbox"  readonly="readonly" multiline="true"  name="contractremark"  value="${idcContract.contractremark}" style="width:84%;height:50px" data-options="validType:'length[0,255]'">
                        </td>
                    </tr>
                    <tr>
