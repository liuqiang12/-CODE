        ...
        <form method="post" id="singleForm" action="<%=request.getContextPath() %>/actJBPMController/procCmentFormSaveOrUpdate.do">
            ...
            <table class="kv-table">
                ...
                <tr>
                    ...
                    <td class="kv-content">
                        <input class="easyui-datetimebox"  name="reservestart" value="${idcRunProcCment.reservestart}" data-options="required:true,editable:false,showSeconds:true,width:150">
                    </td>
                </tr>
                <tr>
