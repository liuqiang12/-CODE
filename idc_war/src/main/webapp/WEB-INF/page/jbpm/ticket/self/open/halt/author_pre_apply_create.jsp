                            ...
                            <div style="float:left">
                                ...
                                <span class="checkbackgrd on_check" id="status_check">
                                    ...
                                    <span class="checkbackgrd" id="status_check">
                                        ...
                                        <input type="checkbox" name="idcRunProcCment_status" value="1" class="opacity_default_0">同意提交申请
                                    </span>
                            </div>
                            <div style="float:left">
                                     <span class="checkbackgrd" id="status_not_check">
                                        <input type="checkbox" name="idcRunProcCment_status" value="0"  class="opacity_default_0">暂不提交申请
                                    </span>
                            </div>
                        </div>
                    </td>
                            ...
                            <div style="position:relative;margin: 0px;" >
                                <div style="float:left">
                                    ...
                                    <span class="checkbackgrd" id="status_check">
                                        ...
                                        <input type="checkbox" name="idcRunProcCment_status" value="1" class="opacity_default_0">重新提交
                                    </span>
                                </div>
                                <div style="float:left">
                                     <span class="checkbackgrd" id="status_not_check">
                                        <input type="checkbox" name="idcRunProcCment_status" value="0"  class="opacity_default_0">结束
                                    </span>
                                </div>
                            </div>
                        </td>
