...
<div class="tip_float_right_info" style="height:23px;line-height:24px;width: 640px;">
...
<div id="jbpmApply_tabs" class="easyui-tabs" fit="true">
    ...
    <div title="资源分配" data-options="closable:false" style="overflow:auto;padding:10px;display:none;">
        ...
        <div style="padding: 5px;" id="requestParamSettins_ticket_port_gridId">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="rackOrUnitOrMcbOrPortOrIpChoiceOperate('200','','port','')">选择端口</a>
        </div>
                    ...
                    <table class="kv-table">
                        ...
                        <%-- <tr>
                             ...
                             <td class="kv-content" colspan="3">
                                 <input class="easyui-textbox" readonly="readonly" data-options="required:true,width:780,height:100,multiline:true"  value="${categoryTicketMeta.APPLYDESC}"  data-options="validType:'length[0,255]'"/>
                             </td>
                         </tr>
                        ...
                        <tr>
                            <td class="kv-label"style="width:100px" >施工描述</td>
                            <td class="kv-content" colspan="3">
