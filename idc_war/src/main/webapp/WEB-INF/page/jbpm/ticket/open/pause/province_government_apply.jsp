                            ...
                            <div style="position:relative;margin: 0px;" >
                                <div style="float:left">
                                    ...
                                    <span class="checkbackgrd" id="status_check">
                                        ...
                                        同意<input type="checkbox" name="idcRunProcCment_status" value="1" class="opacity_default_0">
                                    </span>
                                </div>
                                <div style="float:left">
                                     <span class="checkbackgrd" id="status_not_check">
                                        不同意<input type="checkbox" name="idcRunProcCment_status" value="0"  class="opacity_default_0">
                                    </span>
                                </div>
                            </div>
                        </td>
