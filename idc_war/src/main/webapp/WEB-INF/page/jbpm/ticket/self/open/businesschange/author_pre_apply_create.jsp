                    ...
                    if($(this).hasClass("on_check")){
                        ...
                        if(catalog == 100){
                            ...
                            var ip_fieldset_contentHTML =
                                ...
                                '   <table class="kv-table">'+
                                '        <tr>'+
                                '        <td class="kv-label" style="width: 200px;">IP租用<span style="color:red">&nbsp;*</span><span style="color:red">&nbsp;*</span></td>'+
                                '        <td class="kv-content">'+
                                '        <input class="easyui-combobox" data-options="'+
                                '   valueField: \'value\','+
                                '       textField: \'label\','+
                                ...
                                '           <td class="kv-label">数量(个)<span style="color:red">&nbsp;*</span><span style="color:red">&nbsp;*</span></td>'+
                                '          <td class="kv-content">'+
                                '           <input class="easyui-numberbox"'+
