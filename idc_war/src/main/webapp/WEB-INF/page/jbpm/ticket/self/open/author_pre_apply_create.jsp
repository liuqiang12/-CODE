            ...
            <table class="kv-table" style="width: 100%;height: 100%">
                <tr>
                    ...
                    <td class="kv-content">
                        ...
                        <!--  是否是结束的工单:如果是，则获取历史信息 -->
                        <input id="isProcessEnd_param" value="${idcHisTicket.isProcessEnd}"  type="hidden"/>
                        <input id="isRubbish_param" value="${idcHisTicket.isRubbish}"  type="hidden"/>
