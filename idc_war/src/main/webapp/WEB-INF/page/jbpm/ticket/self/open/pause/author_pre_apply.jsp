                        ...
                        <%--<div style="float:left">
                            ...
                            <span class="checkbackgrd on_check" id="status_check">
                                    ...
                                    <span class="checkbackgrd" id="pauseTatus_check">
                                        ...
                                        <input type="checkbox" name="idcRunProcCment_pauseTatus" value="1" class="opacity_default_0">
                                    </span>临时停机
                        </div>
                        <div style="float:left">
                                     <span class="checkbackgrd" id="pauseTatus_not_check">
                                        <input type="checkbox" name="idcRunProcCment_pauseTatus" value="2"  class="opacity_default_0">
                                    </span>长期停机
                        </div>--%>
                    </div>
                </td>
