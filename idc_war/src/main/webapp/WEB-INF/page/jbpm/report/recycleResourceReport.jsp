...
<div style="padding: 5px;" id="requestParamSettins_taskQuery">
    ...
    业务名称: <input class="easyui-textbox" id="busName" name="busName" style="width:200px;text-align: left;" data-options="">
    <%--客户名称: <input class="easyui-textbox" id="customerName" name="customerName" style="width:200px;text-align: left;" data-options="">--%>
...
<script src="<%=request.getContextPath() %>/js/jbpm/report/recycleResourceReport.js"></script>
