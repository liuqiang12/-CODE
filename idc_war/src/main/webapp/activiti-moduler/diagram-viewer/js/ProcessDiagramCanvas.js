...
var LABEL_COLOR = Color.get(80, 80, 80);
...
var ICON_SIZE = 16;
var ICON_PADDING = 4;
var USERTASK_IMAGE = 		contextPath+"/activiti-moduler/diagram-viewer/images/deployer/user.png";
var SCRIPTTASK_IMAGE = 		contextPath+"/activiti-moduler/diagram-viewer/images/deployer/script.png";
var SERVICETASK_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/service.png";
var RECEIVETASK_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/receive.png";
var SENDTASK_IMAGE = 		contextPath+"/activiti-moduler/diagram-viewer/images/deployer/send.png";
var MANUALTASK_IMAGE = 		contextPath+"/activiti-moduler/diagram-viewer/images/deployer/manual.png";
var BUSINESS_RULE_TASK_IMAGE = contextPath+"/activiti-moduler/diagram-viewer/images/deployer/business_rule.png";
var TIMER_IMAGE = 			contextPath+"/activiti-moduler/diagram-viewer/images/deployer/timer.png";
var MESSAGE_CATCH_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/message_catch.png";
var MESSAGE_THROW_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/message_throw.png";
var ERROR_THROW_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/error_throw.png";
var ERROR_CATCH_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/error_catch.png";
var SIGNAL_CATCH_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/signal_catch.png";
var SIGNAL_THROW_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/signal_throw.png";
var MULTIPLE_CATCH_IMAGE = 	contextPath+"/activiti-moduler/diagram-viewer/images/deployer/multiple_catch.png";
	...
	*/
	...
	onHoverIn: function(event, instance, element){
	  ...
	  if (ProcessDiagramGenerator.options && ProcessDiagramGenerator.options.on && ProcessDiagramGenerator.options.on.over) {
	    var args = [instance, element, contextObject,event.offsetX,event.offsetY];
	 ...
	 addHandlers: function(set, x, y, width, height, type){
	   ...
	   border.attr({stroke: Color.get(109,161,48)/*Color.Tan1*/,"stroke-width": 4, opacity: 0.0});
	   border.id = contextObject.id + "_border";

	   set.push(border);

	   overlay.attr({stroke: Color.Orange,"stroke-width": 3, fill: Color.get(94,194,253), opacity: 0.0, cursor: "hand"});
	   ...
	   overlay.hover(function(event){
          // console.log("overlay.hover(");
	   	instance.onHoverIn(event, instance, this);}, function(event){instance.onHoverOut(event, instance, this);});
	 },
...
// TODO: generate polylineId or do something!!
		...
		*/
		...
		var polyClone = st.clone().attr(polyCloneAttrNormal).hover(function () {
			...
			//console.log("polyCloneAttrNormal");
		...
		polyClone.click(function(obj){
			...
			if (contextObject) {
				...
				ProcessDiagramGenerator.showFlowInfo(contextObject,obj.clientX,obj.clientY);
			}
		}).dblclick(function(){
			...
			if (contextObject) {
				//显示提示信息
                //console.log(x+","+y);
                ProcessDiagramGenerator.showFlowInfo(contextObject,mouseEvent.movementX,mouseEvent.movementY);
            }
		});
