...
var Color = {
  ...
  blue_defined : Raphael.getRGB("rgb(22, 107, 110)"),
  ...
  // http://www.stm.dp.ua/web-design/color-html.php
	...
	OldLace			:   Raphael.getRGB("#d6efff	"),  // 	253 245 230
	...
	Firebrick1		:   Raphael.getRGB("#70cf00	"),  // 	255 48 48
    ...
    Firebrick5		:   Raphael.getRGB("#d6efff	"),  // 	139 26 26
