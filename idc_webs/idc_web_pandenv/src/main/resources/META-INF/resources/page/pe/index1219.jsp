...
<div class="easyui-panel" fit="true" style="overflow-x:hidden">
    <div class="layui-row layui-col-space5">
        <div class="layui-col-xs12 layui-col-sm3 layui-col-md4 everyone" style="margin-top:5px;">
            <blockquote class="layui-elem-quote title">机楼:IDC-XY-B04</blockquote>
        ...
        <div class="layui-col-xs12 layui-col-sm3 layui-col-md4 everyone" style="margin-top:5px;">
                <blockquote class="layui-elem-quote title">机楼:IDC-XY-B05</blockquote>
                <fieldset class="layui-elem-field">
                    <legend>12月12日</legend>
                    <div class="layui-field-box">
                        <div class="layui-row layui-col-space1">
        ...
        <div class="layui-col-xs12 layui-col-sm3 layui-col-md4 everyone" style="margin-top:5px;">
            <blockquote class="layui-elem-quote title">机楼:IDC-XY-B06</blockquote>
            <fieldset class="layui-elem-field">
                <legend>12月12日</legend>
                <div class="layui-field-box">
                    <div class="layui-row layui-col-space1">
        ...
        <div class="layui-col-xs12 layui-col-sm3 layui-col-md4 everyone" style="margin-top:5px;">
            <blockquote class="layui-elem-quote title">机楼:IDC-XY-B07</blockquote>
            <fieldset class="layui-elem-field">
                <legend>12月12日</legend>
                <div class="layui-field-box">
                    <div class="layui-row layui-col-space1">
        ...
        <div class="layui-col-xs12 layui-col-sm3 layui-col-md4 everyone" style="margin-top:5px;">
            <blockquote class="layui-elem-quote title">机楼:IDC-XY-B08</blockquote>
            <fieldset class="layui-elem-field">
                <legend>12月12日</legend>
                <div class="layui-field-box">
                    <div class="layui-row layui-col-space1">
