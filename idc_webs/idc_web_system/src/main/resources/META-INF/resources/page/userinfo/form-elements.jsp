...
<html lang="en">
	<head>
		<%@ include file="/globalstatic/v1.3.2/include.jsp" %>
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
		<!-- page specific plugin styles -->
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/jquery-ui.custom.css" />
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/chosen.css" />
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/datepicker.css" />
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/bootstrap-timepicker.css" />
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/daterangepicker.css" />
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/bootstrap-datetimepicker.css" />
		<link rel="stylesheet" href="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/css/colorpicker.css" />
	</head>
	<body class="no-skin">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 文本组件 </label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> 全长 </label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 只读 </label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">相对大小</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-5">列宽</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">输入框图片样式</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-6">提示框</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">标签输入框</label>
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">智能输入框</h4>
										...
										<div class="col-xs-12 col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">智能选择框</h4>
									...
									<h3 class="header smaller lighter blue">
										复选框 和单选框
										<small>所有的复选框和单选框都利用样式css处理的</small>
									</h3>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">文件选择框</h4>
										...
										<div class="col-sm-4">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">jqueryUI滑动条</h4>
												</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														<label for="id-date-picker-1">日期控件</label>
								...
								<h4 class="pink">
									...
									<a href="#modal-form" role="button" class="blue" data-toggle="modal"> 弹出框 </a>
								</h4>
		...
		<%@ include file="/globalstatic/v1.3.2/includeBottom.jsp" %>
		<!-- page specific plugin scripts -->
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/jquery-ui.custom.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/jquery.ui.touch-punch.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/chosen.jquery.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/fuelux/fuelux.spinner.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/date-time/bootstrap-datepicker.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/date-time/bootstrap-timepicker.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/date-time/moment.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/date-time/daterangepicker.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/date-time/bootstrap-datetimepicker.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/bootstrap-colorpicker.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/jquery.knob.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/jquery.autosize.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/jquery.inputlimiter.1.3.1.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/jquery.maskedinput.js"></script>
		<script src="<%=request.getContextPath() %>/framework/bootstrap1.3.2/assets/js/bootstrap-tag.js"></script>
		<!-- inline scripts related to this page -->
		<script src="<%=request.getContextPath() %>/demo/form/form-elements.js"></script>
	</body>
</html>
