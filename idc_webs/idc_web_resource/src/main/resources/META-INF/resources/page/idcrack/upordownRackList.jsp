        ...
        <div data-options="region:'center',border:false" style="padding-left: 2px;">
            <table id="table" class="easyui-datagrid"
                ...
                <tr>
                    ...
                    <th data-options="field:'ELECTRICENERGY',width:100">电量(KWH)</th>
                    <th data-options="field:'APPARENETPOWER',width:100">电量(KVA)</th>
...
<script type="text/javascript" language="JavaScript">
    ...
    $(function () {
        $('#table').datagrid({
            url: contextPath + "/idcRack/upordownForDeviceRackList",
    ...
    function searchModels() {
        ...
        $('#table').datagrid({
            url: contextPath + "/idcRack/upordownForDeviceRackList",
            queryParams: {name: name, type: type}
        });
    }
</script>
</body>
