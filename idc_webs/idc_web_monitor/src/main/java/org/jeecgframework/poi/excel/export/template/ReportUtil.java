...
/**
 * Created by mylove on 2017/9/18.
 */
public class ReportUtil extends ExcelExportBase {
    ...
    public Workbook createExcleByTemplateManySheet(TemplateExportParams params,
                                          Map<Integer, Map<String, Object>> map) {
        // step 1. 判断模板的地址
        if (params == null || map == null || StringUtils.isEmpty(params.getTemplateUrl())) {
            throw new ExcelExportException(ExcelExportEnum.PARAMETER_ERROR);
