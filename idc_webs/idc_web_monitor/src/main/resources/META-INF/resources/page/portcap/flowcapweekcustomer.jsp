    ...
    <div data-options="region:'north'" style="height: 45px;overflow: hidden">
        <table class="kv-table">
            ...
            <tr>
                ...
                <%--<td class="kv-content">--%>
                    <%--${cyc}--%>
                    <%--&lt;%&ndash;<c:if test="${cyc=='mi'}">5分</c:if>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<c:if test="${cyc=='hour'}">小时</c:if>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<c:if test="${cyc=='day'}">天</c:if>&ndash;%&gt;--%>
                <%--</td>--%>
            </tr>
            </tbody>
        </table>
            ...
            <div data-options="region:'center'">
                ...
                <table id="dg1"class="easyui-datagrid" data-options="fit:true,fitColumns:true,singleSelect:true,showFooter:false,checkbox:true,onLoadSuccess:onLoadSuccess,rowStyler:rowStyler">
                    ...
                    <tr>
                        ...
                        <th colspan="4" data-options="field:'flowtype',align:'center',width:100">${startTime}-${endTime}</th>
                        <%--<th colspan="6" data-options="field:'flowdata',width:100,align:'center'">流量数据</th>--%>
                    </tr>
                    <tr>

                        <th data-options="field:'a_2',align:'center',width:100">入峰值(Gbps)</th>
                        <th data-options="field:'z_2',align:'center',width:100">入峰值利用率(%)</th>
                        <th data-options="field:'a_1',align:'center',width:100">出峰值(Gbps)</th>
                        <th data-options="field:'z_1',align:'center',width:100">出峰值利用率(%)</th>
                    ...
                    <tbody>
                    <c:forEach items="${flows}" var="row" varStatus="status">
                        <tr>
                            <td>${row.portname}</td>
                            <td><fmt:formatNumber value="${row.maxinflowMbps/1024}" pattern="#0.0000"/></td>
                            <td><c:if test="${not empty row.bandwidth&&row.bandwidth>0}">
                                <fmt:formatNumber value="${row.maxinflowMbps/row.bandwidth*100}" pattern="#0.0000"/>%
                            </c:if></td>

                            <td><fmt:formatNumber value="${row.maxoutflowMbps/1024}" pattern="#0.0000"/></td>
                            <td><c:if test="${not empty row.bandwidth&&row.bandwidth>0}">
                                <fmt:formatNumber value="${row.maxoutflowMbps/row.bandwidth*100}" pattern="#0.0000"/>%
                            </c:if></td>
                        </tr>
                    </c:forEach>
                    ...
                    <%--<c:forEach items="${rows}" var="row" varStatus="status">--%>
                        <%--<c:forEach items="${row.value}" var="cellt" varStatus="status">--%>
                            <%--<td>${cellt.key}</td>--%>
                            <%--<td><fmt:formatNumber value="${cellt.value.maxoutflowMbps/1024}"--%>
                                                  <%--pattern="#0.000"/></td>--%>
                            <%--<td><c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">--%>
                                <%--<fmt:formatNumber--%>
                        ...
                        <%--</c:forEach>--%>
                        <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<td>${row.key}</td>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<td>1</td>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<td>2</td>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
                      <%--&lt;%&ndash;<c:forEach items="${row.value}" var="cellt" varStatus="status">&ndash;%&gt;--%>
                          <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>${cellt.key}</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>入流量</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td><fmt:formatNumber value="${cellt.value.maxinflowMbps}"&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;pattern="#0.000"/></td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;<c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">&ndash;%&gt;--%>
                                      <%--&lt;%&ndash;<fmt:formatNumber&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;value="${cellt.value.maxinflowMbps/cellt.value.bandwidth*100}"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;pattern="#0.000"/>%&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td><fmt:formatNumber value="${cellt.value.mininflowMbps}"&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;pattern="#0.000"/></td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;<c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">&ndash;%&gt;--%>
                                      <%--&lt;%&ndash;<fmt:formatNumber&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;value="${cellt.value.mininflowMbps/cellt.value.bandwidth*100}"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;pattern="#0.000"/>%&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td><fmt:formatNumber value="${cellt.value.avginflowMbps}"&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;pattern="#0.000"/></td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;<c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">&ndash;%&gt;--%>
                                      <%--&lt;%&ndash;<fmt:formatNumber&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;value="${cellt.value.avginflowMbps/cellt.value.bandwidth*100}"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;pattern="#0.000"/>%&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                          ...
                          <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>${cellt.key}</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>出流量</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td><fmt:formatNumber value="${cellt.value.maxoutflowMbps}"&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;pattern="#0.000"/></td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;<c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">&ndash;%&gt;--%>
                                      <%--&lt;%&ndash;<fmt:formatNumber&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;value="${cellt.value.maxoutflowMbps/cellt.value.bandwidth*100}"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;pattern="#0.000"/>%&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td><fmt:formatNumber value="${cellt.value.minoutflowMbps}"&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;pattern="#0.000"/></td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;<c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">&ndash;%&gt;--%>
                                      <%--&lt;%&ndash;<fmt:formatNumber&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;value="${cellt.value.minoutflowMbps/cellt.value.bandwidth*100}"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;pattern="#0.000"/>%&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>

                              <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td><fmt:formatNumber value="${cellt.value.avgoutflowMbps}"&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;pattern="#0.000"/></td>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;<td>&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;<c:if test="${not empty cellt.value.bandwidth&&cellt.value.bandwidth>0}">&ndash;%&gt;--%>
                                      <%--&lt;%&ndash;<fmt:formatNumber  value="${cellt.value.avgoutflowMbps/cellt.value.bandwidth*100}"&ndash;%&gt;--%>
                                                         <%--&lt;%&ndash;pattern="#0.000"/>%&ndash;%&gt;--%>
                                  <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                              <%--&lt;%&ndash;</td>&ndash;%&gt;--%>
                          <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
